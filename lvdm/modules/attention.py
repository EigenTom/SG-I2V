...
class CrossAttention(nn.Module):
    ...
    def efficient_forward(self, x, context=None, mask=None):
        ...
        # STORE ATTENTION MAP (Placeholder - xformers might not expose it directly here)
        # For now, let's assume we'd need to disable efficient_forward or modify it 
        # more significantly to get 'sim' if xformers is used.
        # If 'sim' is not available, self.last_attention_map will not be updated in this path.
        # We can add a fallback or a warning later if this path is taken.
        if 'sim' in locals() or 'sim' in globals(): # Check if sim was somehow computed
